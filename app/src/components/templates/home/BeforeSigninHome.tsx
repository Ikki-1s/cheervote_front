      ...
      <div css={styles.wrap}>
        ...
        <div css={styles.subtitleAndPWrap}>
          ...
          <div css={styles.pWrap}>
            ...
            <p>集計結果は即座に反映され、各議員のページにて確認することができます。</p>
            <p>
        ...
        <div css={styles.subtitleAndPWrap}>
          ...
          <div css={styles.pWrap}>
            ...
            <p>
              当サイトはこのような問題意識から、有権者のユーザーの皆様には定期的な評価の投票を通じて普段から議員の活動をチェックする習慣をつけ少しでも日々の政治への関心を高める助けにしていただくと同時に、現役議員の方々に対しては「これだけの有権者があなたの活動をチェックしています、しっかり頑張ってください！」という有権者の声を届けようという試みです。
            </p>
          </div>
        </div>
      </div>
